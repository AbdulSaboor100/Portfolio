...
const PortfolioCards = ({ onClick, img, title, description }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center items-center flex-col absolute top-0 bottom-0 left-0 right-0 overlay-container  h-full bg-main_primary opacity-0 duration-500 ease-in-out hover:opacity-80 z-0">
